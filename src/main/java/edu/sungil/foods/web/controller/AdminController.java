...
public class AdminController {
	...
	@ResponseBody
	public ResponseEntity<List<OrderInfo>> getOrderInfo(OrderInfo orderInfov    ) {
		return new ResponseEntity<List<OrderInfo>>(adminService.getOrderList(orderInfov), HttpStatus.OK);
	}
}
