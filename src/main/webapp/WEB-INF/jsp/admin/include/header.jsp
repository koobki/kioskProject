                        ...
                        <ul class="list-unstyled">
                          <li>
                                <a href="/admin/orderList">
                                    ...
                                    <span class="bot-line"></span>주문관리</a>
                            </li>
                            <li>
                                <a href="/admin/menuList">
                                    <i class="fas fa-tachometer-alt"></i>메뉴관리
                    ...
                    <div class="header__tool">
                        ...
                        <div class="account-wrap">
                            <div class="account-item account-item--style2 clearfix js-item-menu">
                                <div class="image">
                                    <img src="../static/images/icon/avatar-01.jpg" alt="관리자" />
                                </div>
                                <div class="content">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a href="/admin/orderList">
                                <i class="fas fa-shopping-basket"></i>주문관리</a>
                        </li>
                        <li>
                            <a href="/admin/menuList">
                                <i class="fas fa-tachometer-alt"></i>메뉴관리</a>
                        </li>
                        <li>
                            <a href="#">
