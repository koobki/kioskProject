                                ...
                                <div class="table-data__tool-left">
                                    <div class="rs-select2--light rs-select2--sm">
                                        <select id="schOrdDt" class="js-select2" name="time">
                                            ...
                                            <option value="3days" value="3">3일전</option>
                                            <option value="7days" value="7">일주일전</option>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                     <div class="rs-select2--light rs-select2--sm">
                                        <select class="js-select2" name="time">
                                            <option id="schOrdStat" selected="selected" >주문상태</option>
                                            <option value="결제완료">결제완료</option>
                                            <option value="전달완료">전달완료</option>
                                        </select>
                                        <div class="dropDownSelect2"></div>
                                    </div>
                                    <input type="text" placeholder="주문번호" class="au-btn-filter" id="schOrdNo">
                                </div>
